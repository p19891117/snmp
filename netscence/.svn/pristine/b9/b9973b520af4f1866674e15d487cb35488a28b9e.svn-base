...
<html>
	...
	<article class="module width_full">
		<div class="clearfix">
			<h3>全局配置:<span style="line-height:30px;">新增OID</span></h3>
		</div>
		<div style="background: none;width: 98%;">
			<form action="<%=request.getContextPath()%>/Global_configctrl/addOidSetResult">
				<table  class="tablesorter_b border"  >
					<tr> <td>oid</td> <td><input type="text" name="oid"/></td></tr>
