...
<script type="text/javascript">
	function savetask(){
        ...
        if(parseInt($("#beforWin").val()) > 300){
        	alert("前置时间窗口最多300秒");
        	return false;
        }
        if(parseInt($("#afterWin").val()) > 300){
        	alert("后置时间窗口最多300秒");
        	return false;
        }
			...
			<article class="module width_full">
				...
				<table class="tablesorter border" cellspacing="0"
					...
					<tbody>
						...
						<tr>
							<td class="txt_r">启动时间：</td>
							<td>为手工启动时间<sf:hidden path="starTime" style="width: 150px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
							     <sf:errors path="starTime" cssStyle="color:red"/></td>
							<td class="txt_r"><font color="red">*</font>结束时间：</td>
						...
						<tr>
							<td class="txt_r"><font color="red">*</font>正常采集频率（>=8 秒）：</td>
						...
						<tr>
							...
							<td class="txt_r"><font color="red">*</font>振幅计算间隔（正常采集频率2倍以上 秒）：</td>
							<td><sf:input path="swingTime"  style="width: 150px;" />
							     <sf:errors path="swingTime" cssStyle="color:red" /></td>
						</tr>
						<tr>
							<td class="txt_r"><font color="red">*</font>前置时间窗口（<=300秒）：</td>
						...
						<tr>
							<td class="txt_r"><font color="red">*</font>后置时间窗口（<=300秒）：</td>
				...
				<footer>
					<div class="submit_link">
						<c:if test="${fileflag == 'add' || fileflag == 'modify'}">
