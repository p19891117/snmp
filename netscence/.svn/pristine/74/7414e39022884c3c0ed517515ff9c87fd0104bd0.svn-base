...
//                            
    ...
    {  
        ...
        {  
            //从Excel读数据  
            //ExcelOperTools.readExcel("F:\\workspace\\Test\\a.xls");  
            //数据写入Excel  
             File fileWrite = new File("F:\\workspace\\Test\\testWrite1.xls");  
             fileWrite.createNewFile();  
             OutputStream os = new FileOutputStream(fileWrite);  
             ExcelOperTools.writeExcel(os);  
            //修改Excel  
