...
<script>
  ...
  /*  	//ajax获取物理内存使用率
   	...
   	function ajaxGetCpuUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"167"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
  ...
  //ajax获取接口利用率
   	function ajaxGetifSpeed(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"159"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetOctsUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"157"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetOctsSendUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"158"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetJsdbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"153"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetFsdbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"154"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetJscbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"155"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetFscbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"156"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
