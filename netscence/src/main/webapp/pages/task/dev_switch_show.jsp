...
<title>面向网络安全实验和设备测试的实验场景恢复原型系统</title>
    ...
    <style type="text/css">
    .divsize_scroll{overflow-y:scroll;height:341px;overflow-x:hidden}
    .divsize2_scroll{overflow-y:scroll;height:338px;overflow-x:hidden}
    .divsize3_scroll{overflow-y:scroll;height:740px;overflow-x:hidden}
     .divsize4_scroll{overflow-y:scroll;height:151px;overflow-x:hidden}
     .tab11_scroll{overflow-y:scroll;height:167px;overflow-x:hidden}
    .divsize{height:178px}
      ...
      <div class="tab_container" style="margin:0px;">
        <div id="tab_sbss1" class="tab_content" style="display: none;">
          <div class="sbss_jbxx clearfix">
            <div class="sbss_jbxx1 tab11_scroll">
	            <table class="tablesorter_b border" cellspacing="0">
	              <thead><tr><th colspan="3">▼&nbsp;基本信息</th></tr></thead>
	              <tbody>
	                <tr><td width="100">路由器描述</td><td width="100">主机名</td><td width="100">系统正常运行时间</td></tr>
	                <tr><td>${sysDescr}</td><td>${sysName}</td><td>${sysUpTime}</td></tr>
	              </tbody>
	            </table>
            </div>
           <!--  <div class="sbss_jbxx3" id="hardinfo"></div> -->
            ...
            <div class="sbss_jbxx4 clearfix">
               <div class="sbss_jbxx5" style="height:130px;" id="ifSpeed">
               </div>
                <div class="sbss_jbxx6 divsize" style="float:right"><jsp:include page="../chart/route_speed.jsp" /></div>
            <div class="clear"></div>
            </div>
        ...
        <div id="tab_sbss2" class="tab_content" style="display: none;">
          <div class="sbss_wlxx clearfix">
            <div class="divsize_scroll sbss_wlxx1" >
            <table class="tablesorter_b border" cellspacing="0">
              <thead><tr><th colspan="4">▼&nbsp;IP报文信息</th></tr></thead>
              <tbody>
               <%--  <tr><td>IP地址</td><td>应用的接口的索引值</td><td>子网掩码</td><td>重组IP数据报分片的最大长度</td></tr>
                ...
                <tr><td width="300">成功发送已输入的数据报数目</td><td>${ipInDelivers}</td></tr>
                <tr><td width="300">缓存空间不足丢弃的接收报文数</td><td>${ipInDiscards}</td></tr>
                <tr><td width="300">未知或不支持的协议而丢弃的报文的数量</td><td>${ipInUnknownProtos}</td></tr>
                <tr><td width="300">转发的IP数据报数目</td><td>${ipForwDatagrams}</td></tr>
                <tr><td width="300">无效目的地址数据报总数</td><td>${ipInAddrErrors}</td></tr>
                <tr><td width="300">报头错误报总数</td><td>${ipInHdrErrors}</td></tr>
                <tr><td width="300">接收到的数据报(包括错误数据报)总数</td><td>${ipInReceives}</td></tr>
                <tr><td width="300">是否作为IP网关</td><td>${ipForwarding}</td></tr>
              </tbody>
            </table>
            </div>
           <%--  <div class="sbss_wlxx1 divsize_scroll" style="float:right;">
            <table class="tablesorter_b border" cellspacing="0" >
            ...
            <!-- <div class="clear"></div> -->
            <%-- <div class="sbss_wlxx1 divsize2_scroll" style="float:right;">
            <table class="tablesorter_b border" cellspacing="0">
            ...
            <div class="clear"></div> --%>
            <div class="sbss_wlxx1 divsize4_scroll" >
            <table class="tablesorter_b border" cellspacing="0">
              <thead><tr><th colspan="6">▼&nbsp;TCP</th></tr></thead>
              <tbody>
               	<tr><td width="200">收到的报文段总数</td><td>${tcpInSegs}</td></tr>
               	<tr><td width="200">发送的报文段总数</td><td>${tcpOutSegs}</td></tr>
               	<tr><td width="200">可支持的最大TCP连接数</td><td>${tcpMaxConn}</td></tr>
              </tbody>
            </table>
            </div>
            
             <div class="sbss_wlxx1 divsize4_scroll"  style="float:right;" >
	            <table class="tablesorter_b border" cellspacing="0">
	              <thead><tr><th colspan="6">▼&nbsp;UDP</th></tr></thead>
	              <tbody>
	               	<tr><td width="200">UDP输入报文统计</td><td>${udpInDatagrams}</td></tr>
	               	<tr><td width="200">发送的UDP数据报总数</td><td>${udpOutDatagrams}</td></tr>
	               	<tr><td width="200">接收错误数据报数</td><td>${udpInErrors}</td></tr>
	              </tbody>
	            </table>
            </div>
          </div>
...
<%--         <div id="tab_sbss5" class="tab_content" style="display: none;">
          <div class="sbss_jcxx clearfix">
	            ...
	            <div class="sbss_jcxx3 divsize_scroll">
	            	<table class="tablesorter_b border" cellspacing="0">
...
<script>
  ...
  /*  	//ajax获取物理内存使用率
   	...
   	function ajaxGetVMemoryUsed(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"151"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetCpuUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"202"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
  ...
  //ajax获取接口利用率
   	function ajaxGetifSpeed(){
   	    var mUsed = "";
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"196"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
                var result = eval(data);
                mUsed = result.IfSpeed;
            }
       	});
   	...
   	function ajaxGetOctsUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"194"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetOctsSendUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"195"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetJsdbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"190"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetFsdbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"191"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetJscbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"192"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
   	...
   	function ajaxGetFscbUserd(){
   		...
   		$.ajax({
            url : 'getUserd',
            data:{"ip":'${ip }',"task_id":'${taskid}',"gather_id":"193"},
            type : 'post',
            async: false,//同步
            dataType:"json",
            success : function(data) {
