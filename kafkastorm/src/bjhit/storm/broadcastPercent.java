...
public class broadcastPercent extends associatedData{
	String SEPARATOR = "#$#";
	public broadcastPercent(String gatherid){
	...
	public String[] getcalData() {
		...
		for (Entry<String, HashMap<String,String>> entry : rr.entrySet()) {
			 //if(entry.getValue().get("1.3.6.1.2.1.25.2.3.1.2."+entry.getKey()).equals("1.3.6.1.2.1.25.2.1.4")){
				 ...
				 BigDecimal mi = new BigDecimal((String)this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.2.2.1.18")));
				 BigDecimal mj = new BigDecimal((String)this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.2.2.1.12")));
