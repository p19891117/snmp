...
public class sendICMPErrorPP extends associatedData{
	String SEPARATOR = "#$#";
	public sendICMPErrorPP(String gatherid){
	...
	public String[] getcalData() {
		...
		if(this.calculateAccesible == this.calculateInNeed){
			...
			//compute formular
			BigDecimal mi = new BigDecimal(this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.15.0")));
			BigDecimal mj = new BigDecimal(this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.14.0")));
			BigDecimal mk = mi.divide(mj, 2,RoundingMode.HALF_DOWN);
			...
			Date date=new Date();  
			 ...
			 //STDIO
			System.out.println("sendICMPErrorPP");
			System.out.println("1.3.6.1.2.1.5.15 value is "+this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.15.0")));
			System.out.println("1.3.6.1.2.1.5.14 value is "+this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.14.0")));
		...
		return null;
			...
			System.out.println("1.3.6.1.2.1.5.14 value is "+this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.14.0")));
			System.out.println("the value is "+this.value);
			System.out.println("sendICMPErrorPP END");
			e.printStackTrace();
			return null;
		}
	}
