...
public class rcvICMPErrorPP extends associatedData{
	String SEPARATOR = "#$#";
	public rcvICMPErrorPP(String gatherid){
		...
		// TODO Auto-generated method stub
			...
			if(this.calculateAccesible == this.calculateInNeed){
				try{
					...
					//compute formular
					BigDecimal mi = new BigDecimal(this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.2.0")));
					BigDecimal mj = new BigDecimal(this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.1.0")));
					...
					System.out.println("1.3.6.1.2.1.5.2 value is "+this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.2.0")));
					System.out.println("1.3.6.1.2.1.5.1 value is "+this.caloidvalue.get(this.caldoid.indexOf("1.3.6.1.2.1.5.1.0")));
